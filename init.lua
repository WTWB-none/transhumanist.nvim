...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>ww', '<cmd>w<CR>', { desc = '[W]rite changes to file' })
vim.keymap.set('n', '<leader>wq', '<cmd>wq<CR>', { desc = '[W]rite changes and [Q]uit neovim' })
...
vim.keymap.set('n', '<leader>sm', '<cmd>Mason<CR>', { desc = '[S]earch [M]ason plugins' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>s.', builtin.colorscheme, { desc = '[S]earch Recent Files ("." for repeat)' })
      vim.keymap.set('n', '<leader>sc', builtin.colorscheme, { desc = '[S]earch Colorscheme' })
      vim.keymap.set('n', '<leader>sf', builtin.find_files, { desc = 'Open file [E]xplorer' })
